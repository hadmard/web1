  ...
  return (
    <section className="section-tone-b border-b border-border py-12 sm:py-16">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <article data-reveal="zoom-soft" className="glass-panel spotlight-card p-5 sm:p-7" data-mouse-zone>
          <div className="showcase-frame media-zoom-smooth mb-4 overflow-hidden rounded-xl border border-border">
            {hasImage ? (
              <Image
                ...
                className="h-32 w-full object-cover object-[center_38%] sm:h-48"
              />
            ) : (
          ...
          <h2 className="mt-1 font-serif text-[1.55rem] font-semibold text-primary sm:text-3xl">华点榜 · 本年度信用推荐</h2>
          <p className="mt-3 text-[13px] leading-6 text-muted sm:text-sm">华点榜作为长期运行的信用体系，按年度更新并持续归档公示。</p>
          <div className="mt-5 grid gap-4 lg:grid-cols-3 sm:mt-6">
