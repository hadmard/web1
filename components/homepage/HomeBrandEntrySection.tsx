...
import type { HomepageBrandItem } from "@/lib/homepage-data";
            ...
            {enterprises.slice(0, 6).map((enterprise) => (
              ...
              >
                ...
                <div className="mt-2.5 flex flex-wrap items-center justify-between gap-2 sm:mt-3">
                  ...
                  <span className="text-xs font-medium text-accent">{enterprise.contactLabel}</span>
                </div>
              </Link>
            ))}
          </div>
